...
public class MysqlDsnBeanDefinitionParser implements BeanDefinitionParser {
	...
	protected BeanDefinition createNosql(String jdbcId, ParserContext parserContext) {
		...
		BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(DataSourceClassUtil.getNosqlMysqlImpl());
	...
	public static BeanDefinition createJdbc(String jdbcId, String dataSourceId, Element element, ParserContext parserContext) {
	...
	private static BeanDefinition createDataSource(String dataSourceId, Element element, ParserContext parserContext) {
		String name = element.getAttribute("name");

		final String maxPoolSize = element.getAttribute("maxPoolSize");
		final String port = element.getAttribute("port");

		BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(DataSourceClassUtil.getMysqlDsnDataSource());
