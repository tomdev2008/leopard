...
import io.leopard.monitor.thread.ThreadMonitorService;
...
public class MonitorBeanFactory {
	...
	public static ThreadMonitorService getThreadMonitorService() {
		return (ThreadMonitorService) getBean("threadMonitorService");
	}
