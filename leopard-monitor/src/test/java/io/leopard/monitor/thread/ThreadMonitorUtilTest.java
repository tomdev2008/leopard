...
public class ThreadMonitorUtilTest {
	...
	public void getCategory() {
		...
		Assert.assertEquals("Dao", ThreadMonitorUtil.getCategory("com.duowan.news.dao.mysql.NewsDaoMysqlImpl.get(NewsDaoMysqlImpl.java:43)"));
	...
	public void isIgnoreThreadName() {
		...
		Assert.assertFalse(ThreadMonitorUtil.isIgnoreThreadName("com.duowan.news.Test"));
		Assert.assertTrue(ThreadMonitorUtil.isIgnoreThreadName("com.duowan.news.Test$$A1"));
		Assert.assertTrue(ThreadMonitorUtil.isIgnoreThreadName("io.leopard.monitor.thread.A1"));
	}

	@Test
	public void isCompanyThreadName() {
		Assert.assertTrue(ThreadMonitorUtil.isCompanyThreadName("com.duowan.news.Test"));
