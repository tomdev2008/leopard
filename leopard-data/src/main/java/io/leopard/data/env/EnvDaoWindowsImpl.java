 ...
 * 
 */
public class EnvDaoWindowsImpl implements EnvDao {
	...
	protected String getPath() {
		...
		if (path == null) {
			...
			throw new NullPointerException("怎么会拿不到classpath[isWindows:" + isWindows + ",osName:" + osName + ",projectName:" + projectName + "]?");
		}
