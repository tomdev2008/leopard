...
public class Log4jPropertiesParserImpl implements Log4jPropertiesParser {
	...
	protected String getDefaultConfig() {
		...
		sb.append("log4j.appender.A1.File=/log/resin/all.log\n");
		sb.append("\n");
		...
		sb.append("log4j.appender.W1.File=/log/resin/warn.log\n");
		sb.append("\n");
		...
		sb.append("log4j.appender.E1.File=/log/resin/error.log\n");
		sb.append("\n");
		return sb.toString();
	}
