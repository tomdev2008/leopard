...
public class FieldUtil {
	...
	public static Object getFieldValue(Object bean, String fieldName) {
		...
		if (field == null) {
			throw new NoSuchFieldRuntimeException("在对象[" + bean.getClass().getName() + "]找不到属性[" + fieldName + "].");
		}
	...
	public static Object getFieldValue(Object bean, Class<?> type) {
		...
		if (field == null) {
			throw new NoSuchFieldRuntimeException("在对象[" + bean.getClass().getName() + "]找不到属性[" + type.getSimpleName() + "].");
		}
		return getFieldValue(bean, field);
	}
