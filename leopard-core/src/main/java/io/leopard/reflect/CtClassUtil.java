...
public class CtClassUtil {
	...
	protected static final Log logger = LogFactory.getLog(CtClassUtil.class);
	...
	public static String[] getParameterNames(CtMethod ctMethod) throws NotFoundException {
		...
		for (int i = 0; i < paramNames.length; i++) {
			...
			try {
				...
				logger.error("ctMethod.getLongName():" + ctMethod.getLongName());
				logger.error("paramNames:" + StringUtils.join(paramNames, ","));
				throw e;
			}
		}
